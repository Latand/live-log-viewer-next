...
| `LLV_REAPER_ENABLED` | `1` enables verified pane cleanup by the deterministic agent reaper. Unset keeps dry-run mode and exposes its latest report at `GET /api/lifecycle/reaper`. |
