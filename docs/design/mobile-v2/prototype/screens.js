/* The key screens of the mobile-v2 prototype (issue #1439). Loaded by the
   ...
   matrix, so the two can never list different screens. */
(function (root) {
  const SCREENS = [
    { id: "board", hash: "#/board", title: "Board — project overview with the attention banner" },
    { id: "board-attention", hash: "#/board/attention", title: "Attention queue sheet" },
    ...
    { id: "chat-working", hash: "#/chat/c1", title: "Conversation — working with elapsed time" },
    { id: "chat-waiting", hash: "#/chat/c2", title: "Conversation — waiting for a reply" },
    ...
    { id: "chat-menu", hash: "#/chat/c1/menu", title: "Conversation overflow menu" },
