...
> Applied on 2026-09-02 in the same pipeline: README §12 (“Critique round”) records what changed per finding and the two points declined; the new gates are in §8 and in `capture.ts`.
