...
| `WAKATIME_API_KEY` | Operator secret manager | Supplies the server-only WakaTime API key. It takes precedence over `${XDG_CONFIG_HOME:-~/.config}/agent-log-viewer/wakatime-api-key`. |
