...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "composer.payloadDiscardPreparation": "Видалити збережену підготовку",
  "composer.payloadCorrupt": "Не вдалося перевірити збережене повідомлення. Перевірте стан його початкової операції.",
  ...
  "composer.payloadLocal": "Збережено локально. Запит ще не підготовлено.",
  ...
  "composer.payloadIncomplete": "початкові дані неповні",
