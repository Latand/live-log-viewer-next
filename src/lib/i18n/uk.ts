...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "operator.keyPrompt": "Ключ оператора",
  "operator.keyHint": "Надрукований у терміналі, з якого ви запустили переглядач. Зберігається лише для цієї вкладки — після перезавантаження треба вставити знову, бо будь-де, де його можна було б зберегти, його прочитають агенти на цій машині.",
  "operator.keyRefused": "Спершу вставте ключ.",
  "operator.keyApply": "Розблокувати",
