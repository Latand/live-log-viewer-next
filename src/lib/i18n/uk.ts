...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "voice.unauthorized": "Голосові дзвінки потребують операторського посилання. Відкрийте Viewer за посиланням із його термінала або вставте його в голосовий контрол і спробуйте ще раз.",
  "voice.needsOperator": "Голос потребує операторського посилання",
  "voice.operatorGateHint": "Голос розблоковується у вкладці, відкритій за операторським посиланням, яке сервер друкує у своєму терміналі під час запуску. Вставте це посилання (або його ключ) сюди, щоб розблокувати цю вкладку.",
  "voice.operatorGatePaste": "Вставте операторське посилання",
  "voice.operatorGateApply": "Розблокувати",
  "voice.operatorGateInvalid": "Це не схоже на операторське посилання чи ключ.",
