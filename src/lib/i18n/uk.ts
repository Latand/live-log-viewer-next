...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "overlay.title": "Ваш агент",
  "overlay.popOut": "Відкрити в окремому вікні",
  "overlay.dock": "Повернути на сторінку",
  "overlay.stop": "Зупинити",
  "overlay.composer": "Написати агентові",
  "overlay.send": "Надіслати",
  "overlay.state.idle": "Очікує",
  "overlay.state.listening": "Слухає",
  "overlay.state.speaking": "Говорить",
  "overlay.state.working": "Працює",
  "overlay.continuedFrom": "Продовження попередньої розмови",
  ...
  "attention.acceptOpen": "Відкрити",
  "attention.preview": "Попередній перегляд",
  "attention.decline": "Не зараз",
  "attention.return": "Назад, де ви були",
  "attention.returnLine": "Повернутися туди, де ви були",
  "attention.approximate": "Цього вже немає — це місце, де воно було.",
  "attention.followedElsewhere": "Перейдено на іншому пристрої",
