...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "queue.filesUnsupported": "Черга Codex приймає лише текст і зображення, тому нічого не поставлено в чергу, а чернетка лишилася без змін. Надішли її через Enter, щоб доставити файл, або прибери файл, щоб поставити в чергу решту.",
