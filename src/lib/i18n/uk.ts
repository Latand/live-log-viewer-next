...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "queue.retentionFull": "Не надіслано. Ця картка вже тримає всі незавершені операції черги, які цей браузер здатен відстежити \u2014 заверши одну, перш ніж починати наступну.",
