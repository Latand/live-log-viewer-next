...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "queue.retentionRefused": "Не надіслано. Цей браузер не може зберегти запис, який робить операцію черги відновлюваною, тож Codex нічого не отримав. Заверши незавершену операцію на цій картці, якщо така є; інакше сховище заповнене або заблоковане, а нова вкладка починає з порожнього.",
