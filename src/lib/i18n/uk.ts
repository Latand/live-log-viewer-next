...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "tasks.showOnBoardTitle": "Малювати смугу цієї задачі на дошці. Саму задачу ніколи не видаляють.",
  "tasks.removeFromBoardTitle": "Не малювати порожню смугу цієї задачі. Вона лишається в списку, а смуга повернеться сама, щойно на ній буде агент.",
