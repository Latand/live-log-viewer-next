...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "migrate.confirmBody": "{total} поточних сесій перейдуть на цей акаунт зі збереженням розмов. {idle} перемкнуться одразу; {busy} — після завершення поточного ходу. Нові агенти одразу використовують «{label}».",
  "migrate.confirmCta": "Перемкнути й мігрувати",
  "migrate.confirmCancel": "Скасувати",
  "migrate.retargetTitle": "Перенаправити міграцію на «{label}»?",
  "migrate.retargetBody": "Міграція на «{current}» ще триває. Решта сесій перейде на «{label}»; вже перенесені сесії мігрують ще раз.",
