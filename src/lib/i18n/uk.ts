...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "runtime.receipt.unconfirmedWhy": "Агент не виходив із ходу, тому це повідомлення так і не передали. Ніхто більше не повторить спробу: надішліть ще раз, якщо воно досі потрібне.",
  "runtime.receipt.unconfirmedWhyHost": "Вікно агента зникло до того, як повідомлення передали, і розмову ніхто не перебрав. Ніхто більше не повторить спробу: надішліть ще раз, якщо воно досі потрібне.",
  "runtime.receipt.unconfirmedWhyUnknown": "Повідомлення прийняли, але так і не передали, і тут ніхто не може сказати чому. Ніхто більше не повторить спробу: надішліть ще раз, якщо воно досі потрібне.",
