...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "orchPanel.mandateSummary": "Мандат v{version} — вбудовані правила роботи (редагувати)",
  "orchPanel.mandateSummaryCustom": "Мандат — ваші власні правила роботи (редагувати)",
