...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "telegram.report.promptPreamble": "Viewer завжди додає перед вашим текстом вікно, вибрані джерела, шлях виводу, перевірку акаунта та правила послідовного читання.",
