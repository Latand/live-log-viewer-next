...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "runtime.receipt.unconfirmedWhyUnknown": "Повідомлення прийняли, але так і не передали, і тут ніхто не може сказати чому. Ніхто більше не повторить спробу — надішліть ще раз або приберіть.",
