...
export const uk: Record<keyof typeof en, Message> = {
  ...
  "queue.runsOn": "Виконається на {settings} — Codex застосовує налаштування треду в момент відправки з черги.",
  "queue.runsOnThread": "Виконається на налаштуваннях треду в момент відправки з черги.",
