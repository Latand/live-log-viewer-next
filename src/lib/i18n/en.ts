...
export const en = {
  ...
  "composer.payloadDiscardPreparation": "Remove saved preparation",
  "composer.payloadCorrupt": "The saved message could not be verified. Re-check its original operation before recovery.",
  ...
  "composer.payloadLocal": "Saved locally. No request was prepared.",
  ...
  "composer.payloadIncomplete": "original payload incomplete",
