...
export const en = {
  ...
  "orchPanel.seatStays": "Stays on the board",
  "orchPanel.seatStaysTitle": "The project's orchestrator keeps its place above the board. Collapse it when you need the room.",
  "orchPanel.seatCollapse": "Collapse the orchestrator chat",
  "orchPanel.seatExpand": "Expand the orchestrator chat",
