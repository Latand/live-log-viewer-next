...
export const en = {
  ...
  "kanban.account.whenSending": "asking…",
  ...
  "kanban.account.noteWorking": "The running turn is never interrupted. The switch waits for it to end, then this conversation continues on the chosen account.",
  "kanban.account.noteIdle": "No turn is running: the switch starts now, and the next message goes to the chosen account.",
  ...
  "kanban.account.receipt.requestedWaits": "Switch to {account} requested for {name}. It waits for the current turn to end.",
