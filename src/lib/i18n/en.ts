...
export const en = {
  ...
  "queue.runsOn": "Runs on {settings} — Codex applies the thread’s settings when it dispatches a queued message.",
  "queue.runsOnThread": "Runs on the thread’s settings when Codex dispatches it.",
