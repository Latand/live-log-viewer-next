...
export const en = {
  ...
  "kanban.otherSurfaces": { one: "{count} review deck or draft · open on the board", other: "{count} review decks or drafts · open on the board" },
  ...
  "kanban.graph.failRetry": "fail · retry {n} of {max}",
  "kanban.graph.legendFail": "{from} → {to} on fail · retry {n} of {max}",
