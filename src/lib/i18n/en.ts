...
export const en = {
  ...
  "migrate.confirmBody": "{total} current sessions will move to this account and keep their conversations. {idle} switch now; {busy} switch after their current turn finishes. New agents use «{label}» immediately.",
  "migrate.confirmCta": "Switch & migrate",
  "migrate.confirmCancel": "Cancel",
  "migrate.retargetTitle": "Redirect migration to «{label}»?",
  "migrate.retargetBody": "A migration to «{current}» is still running. Remaining sessions will go to «{label}» instead; already-moved sessions will migrate again.",
