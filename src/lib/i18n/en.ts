...
export const en = {
  ...
  "tasks.showOnBoardTitle": "Draw a band for this task on the board. The task itself is never deleted.",
  "tasks.removeFromBoardTitle": "Stop drawing an empty band for this task. It stays in this list, and its band returns by itself once an agent is on it.",
