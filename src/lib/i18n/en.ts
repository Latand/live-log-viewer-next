...
export const en = {
  ...
  "telegram.report.promptPreamble": "The Viewer always adds the window, the selected sources, the output path, the account check and the sequential-read rules in front of your text.",
