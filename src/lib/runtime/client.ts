...
export interface RuntimeHostClient {
  ...
  waitEvents(after: number, timeoutMs?: number): Promise<RuntimeReplay>;
...
export class UnixRuntimeHostClient implements RuntimeHostClient {
  ...
  waitEvents(after: number, timeoutMs = 15_000): Promise<RuntimeReplay> { return this.call("wait", { after, timeoutMs }, timeoutMs + 1_000) as Promise<RuntimeReplay>; }
  ...
  private call(method: RuntimeSocketRequest["method"], params?: Record<string, unknown>, timeoutMs = this.timeoutMs): Promise<unknown> {
