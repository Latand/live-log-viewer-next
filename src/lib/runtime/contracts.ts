...
export interface RuntimeSocketRequest {
  id: string;
  method: "snapshot" | "events" | "wait" | "append" | "operation" | "command" | "operation-status" | "effect-batch" | "operation-transition" | "viewer-deployment-request" | "viewer-deployment-read";
