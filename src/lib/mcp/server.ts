...
export const TOOL_INPUT_SCHEMAS: Record<McpToolName, z.ZodObject> = {
  ...
  conversation_messages: z.object({
    ...
    cursor: z.string().min(1).optional()
      .describe("Opaque cursor from the preceding page. Pass it unchanged for the next-older page while hasMore is true."),
  }).passthrough(),
