...
export function MobileConversationMenu({
  ...
  onOpenSearch?: () => void;
  /** Swaps this sheet for the project's own menu. Interim: the board has no
      screen of its own until lane 2, so its `⋯` would otherwise be
      ...
      <MobileSheet name="menu" title={title} onClose={onClose}>
        ...
        <div role="menu" aria-label={title} className="flex flex-col">
          ...
          <MobileSheetRow
            ...
            trailing={t("mobile2.menu.hostTasks", { count: hostTaskCount })}
