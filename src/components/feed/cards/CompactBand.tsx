  ...
  return (
    <div className="my-3.5">
      <div className="flex items-center gap-2.5">
        <span className="h-px flex-1 bg-info/30" aria-hidden />
        <span className="inline-flex items-center gap-1.5 rounded-full border border-info/30 bg-info-soft px-2.5 py-1 text-[11px] font-bold text-info">
      ...
      {item.summary ? (
        <details className="group/cmp mt-1.5 text-center">
          <summary className="cursor-pointer list-none text-[11px] font-semibold text-info [&::-webkit-details-marker]:hidden">
          ...
          <pre className="mt-1 max-h-[320px] overflow-auto whitespace-pre-wrap break-words rounded-[10px] border border-border bg-canvas px-3 py-2 text-left font-mono text-[11px] text-secondary">
            {item.summary}
          </pre>
        </details>
      ) : null}
