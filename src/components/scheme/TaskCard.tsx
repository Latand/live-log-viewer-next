...
import { CornerDownRight, Loader2, Send, Trash2, Zap } from "lucide-react";
...
function SendPicker({
  ...
  /* «⤷ всім дітям»: checks the parent and every conversation under it. */
    ...
    >
      ...
      <div className="flex max-h-[240px] flex-col gap-0.5 overflow-y-auto">
        {conversations.length ? (
          ...
          <div className="px-1.5 py-2 text-[11px] text-dim">{t("tasks.pickerEmpty")}</div>
        )}
      </div>
