...
function AuthIdentity({ account }: { account: AccountOption }) {
  ...
  return (
    <span className="flex min-w-0 items-center gap-1 text-[9.5px] font-medium text-dim">
    ...
    <div>
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          <span className={`block truncate text-[12.5px] ${isActive ? "font-bold text-ink" : "font-semibold"}`}>{account.label}</span>
