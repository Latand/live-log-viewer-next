...
export async function PATCH(req: NextRequest) {
  ...
  try { return NextResponse.json(agentRegistry().setAutoBalancePolicy("codex", body.automaticSwitching, typeof body.expectedRevision === "number" ? body.expectedRevision : undefined)); }
